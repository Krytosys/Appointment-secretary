...
class AddModal extends Component {
    ...
    handleSubmit=e=>{
      ...
      const appointment = {
        ...
        patientcontact:'09221892837',
        process:'cleaning',
        notes:this.state.date.toDateString(),
    ...
    render(){
      const {firstname, lastname, patientcontact, process, notes, date, time, doctor} = this.state;
      const values = {firstname, lastname, patientcontact, process, notes, date, time, doctor}
      let button;
      let button2;
